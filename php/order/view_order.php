...
<head>
    ...
    <title>Panel STORAGEHOST - Hosting Services / Commandes</title>
    <script>
        function displayWip() {
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link active" href="order.php">Vos commandes</a>
                </li>
            </ul>
...
<main style="margin-top: 15px;" class="container-fluid text-center bg-light2 mt-xl-3">
    <section class="container mb-xl-5">
        <h2 class="text-center mb-xl">Vos commandes</h2>
        <div class="container border-top mt-xl-3">
            <div class="row">
                <div class="col-md-12">
                    <button onclick="location.href = 'php/order/new/new.php';"
                            class="btn btn-info mt-3 float-md-right"
                            type="submit">Nouvelle commande
                    </button>
                </div>
            </div>
            <div class="row">
